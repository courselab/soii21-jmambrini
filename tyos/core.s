...
#APP
# 92 "core.c" 1
	reset42:                    ;    mov $0x0, %ah          ;    mov $0x0, %dl          ;    int $0x13               ;    jnc load42             ;    call fatal              ;   mov $0x0, %cx           ;   mov %cx, %es           ; load42:                    ;   mov $0x2, %ah           ;   mov $1, %al           ;   mov $0x0, %dl           ;   mov $0x0, %ch           ;   mov $0x0, %dh           ;   mov $0x2, %cl           ;   mov $0x7e00, %bx        ;   int $0x13                ;   jc fatal                 ;   ret                      ;
# 0 "" 2
#NO_APP
	nop
	ud2
